...
function Admin(){
    ...
    return(
        <main className="flex-1">
            ...
            <section className=" flex justify-center [&_i]:mr-3 mx-3 [&_h1]:font-bold [&_span]:text-sm gap-2 mt-4 bg-white rounded-md md:text-3xl p-4">
                <div className="w-full max-w-[1336px] grid grid-cols-2 lg:flex lg:justify-between">
            ...
            <div className="flex justify-center w-full">
                <div className="mt-10 mx-3 flex justify-start mb-10 gap-5 items-center border-b-1 border-gray-500/40 md:text-lg max-w-[1336px] w-full">
            ...
            <div className="w-full flex justify-center">
                <section className="m-3 rounded-t-md w-full max-w-[1336px] border-gray-500/50  border-1">
