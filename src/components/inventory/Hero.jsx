    ...
    return(
       <div className="bg-[url('/blake-meyer-CRNbHjNaljo-unsplash.jpg')] bg-cover bg-center h-130 w-full">
            <div className="w-full h-full text-white flex flex-col items-center justify-center text-center bg-black/15">
                ...
                <input onChange={(e) => setQuery(`https://car-dealer-api-2ie4.onrender.com/api/car/search?q=${e.target.value}`)} className="max-w-2xl bg-white/30 text-sm w-[80dvw]  h-12 m-8 rounded-full pl-4 backdrop-blur-sm border border-white/80" type="text" placeholder="Search by brand, model, or category..."/>  
